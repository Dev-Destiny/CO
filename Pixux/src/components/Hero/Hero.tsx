...
function Hero() {
	...
	return (
		<section className='pad pt-40 pb-60 mb-[3rem] bg-blue-100'>
			<div className='mx-auto flex flex-col gap-5 items-center text-center max-w-[700px]'>
				...
				<h1 className='font-semibold text-[#050327] lg:text-[3rem] md:text-[1.6rem] text-[2rem] '>
				...
				<div className='flex flex-col gap-5 mt-5 sm:flex-row md:flex-row'>
					<Button type='primary'>Start Learning Free</Button>
