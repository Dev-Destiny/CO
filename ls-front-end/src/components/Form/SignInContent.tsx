...
function SignInContent() {
  return (
    <div className="flex flex-col gap-5">
      <h1 className="text-3xl">Master Programming <br/> <span className="text-accent">The Smart Way</span></h1>
      <p className="text-text-muted">Join thousands of developers who are advancing their careers with CO's interactive learning platform.</p>
    ...
    <div className="border-1 rounded-xl border-border p-5 flex justify-between w-full items-center">
        <div>
            <h1>Trusted by industry leaders</h1>
            <p className=" text-[12px]">Start learning today with no credit card required</p>
        </div>
        <div className="flex gap-2 items-center">
            <div className="bg-green-500 p-1 w-fit h-fit rounded-full"></div>
            <p className="text-[12px] ">Free to start</p>
        </div>
      </div>
    </div>
  )
