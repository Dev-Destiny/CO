	...
	return (
		<div>
			<form action='' onSubmit={handleSignup}>
				...
				<p className='text-[12px] text-gray-500 w-full mb-10'>
				...
				<p className='text-[12px] text-gray-500 w-full mb-10 text-center'>
					By signing up, you'll get access to our interactive courses
					and join thousands of learners improving their programming
					skills.
				</p>
			</form>
		</div>
