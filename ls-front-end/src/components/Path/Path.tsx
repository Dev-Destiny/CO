...
const Path = () => {
	return (
		<div className='py-20 pad mb-20 bg-bg-light'>
			<Header
				title='How LearnScape Works'
				text='Our proven 4-step learning methodology gets you from beginner to job-ready developer.'
			/>
			<div className='grid lg:grid-cols-4 grid-cols-1 md:grid-cols-2 gap-10 container mx-auto mt-20'>
			...
			<div className='mt-20 lg:p-20 p-10 rounded-2xl bg-surface w-fit mx-auto'>
				<Header
