...
const TestimonialCard = ({ stars, img, name, message, position, course }: TestimonialCardProps) => {
	return (
		<div className="flex flex-col gap-5 bg-surface p-5 rounded-2xl shadow-[0_0_5px_rgba(100,100,100,0.2)]">
			<div className="flex">
				{[...Array(stars)].map((_, i) => (
